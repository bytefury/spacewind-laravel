<template>
	<div>
		<sw-page-header title="Form Laouts">
			<template v-slot:breadcrumbs>
				<sw-breadcrumb>
					<sw-breadcrumb-item title="Home" to="/dashboard" />
					<sw-breadcrumb-item title="Form" to="/form/form-layouts" />
					<sw-breadcrumb-item title="Form Layouts" active />
				</sw-breadcrumb>
			</template>
		</sw-page-header>
		<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
			...
			<sw-card class="my-4">
				...
				<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
					<sw-input-group label="First Name">
						<sw-input placeholder="First Name"/>
					</sw-input-group>
					<sw-input-group label="Last Name">
						<sw-input placeholder="Last Name"/>
					</sw-input-group>
				</div>
				<sw-input-group label="Email" class="mt-2">
					<sw-input type="email" placeholder="Enter email"/>
					<span class="text-xs text-gray-600">We'll never share your email with anyone else.</span>
				</sw-input-group>
				<sw-input-group label="Username" class="mt-2">
					<sw-input placeholder="Username"/>
				</sw-input-group>
				<sw-input-group label="Gender" class="mt-2">
					<div class="flex">
						<sw-radio label="Male" size="sm" name="gender"/>
						<sw-radio label="Female" size="sm" name="gender" class="ml-4"/>
					</div>
				</sw-input-group>
				<sw-input-group label="Password" class="mt-2">
					<sw-input :type="getInputType" placeholder="Password">
			...
			<sw-card class="my-4">
				...
				<sw-input-group label="First Name" variant="horizontal">
					<sw-input placeholder="First Name"/>
				</sw-input-group>
				<sw-input-group label="Last Name" variant="horizontal" class="mt-2">
					<sw-input placeholder="First Name"/>
				</sw-input-group>
				<sw-input-group label="Email" variant="horizontal" class="mt-2">
					<sw-input type="email" placeholder="Enter email"/>
					<span class="text-xs text-gray-600">We'll never share your email with anyone else.</span>
				</sw-input-group>
				<sw-input-group label="Password" variant="horizontal" class="mt-2">
					<sw-input :type="getInputType" placeholder="Password">
						<template v-slot:rightIcon>
							<svg v-if="isShowPassword" class="w-5 h-5 mr-1 text-gray-500 cursor-pointer" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" @click="isShowPassword = !isShowPassword">
								<path fill-rule="evenodd" d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-1.473-1.473A10.014 10.014 0 0019.542 10C18.268 5.943 14.478 3 10 3a9.958 9.958 0 00-4.512 1.074l-1.78-1.781zm4.261 4.26l1.514 1.515a2.003 2.003 0 012.45 2.45l1.514 1.514a4 4 0 00-5.478-5.478z" clip-rule="evenodd"></path><path d="M12.454 16.697L9.75 13.992a4 4 0 01-3.742-3.741L2.335 6.578A9.98 9.98 0 00.458 10c1.274 4.057 5.065 7 9.542 7 .847 0 1.669-.105 2.454-.303z"></path>
		...
		<sw-card class="my-4">
			<template v-slot:header>
				<span class="sw-section-title">Inline Form</span>
			</template>
			<div class="flex flex-row items-center">
				<sw-input-group label="email@example.com" variant="horizontal">
					<sw-input :type="getInputType" placeholder="Password">
						<template v-slot:rightIcon>
							<svg v-if="isShowPassword" class="w-5 h-5 mr-1 text-gray-500 cursor-pointer" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" @click="isShowPassword = !isShowPassword">
								<path fill-rule="evenodd" d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-1.473-1.473A10.014 10.014 0 0019.542 10C18.268 5.943 14.478 3 10 3a9.958 9.958 0 00-4.512 1.074l-1.78-1.781zm4.261 4.26l1.514 1.515a2.003 2.003 0 012.45 2.45l1.514 1.514a4 4 0 00-5.478-5.478z" clip-rule="evenodd"></path><path d="M12.454 16.697L9.75 13.992a4 4 0 01-3.742-3.741L2.335 6.578A9.98 9.98 0 00.458 10c1.274 4.057 5.065 7 9.542 7 .847 0 1.669-.105 2.454-.303z"></path>
		...
		<!-- <div> -->
			...
			<!-- <sw-card class="my-4">
				...
				<div class="grid grid-cols-1 gap-4 md:grid-cols-3">
					...
					<sw-input-group label="Amount">
						<sw-money v-model="money_1" :currency="currency_1"/>
					</sw-input-group>
					<sw-input-group label="Date Of Birth">
						<sw-date-picker v-model="date_1" placeholder="dd-mm-yyyy"/>
					</sw-input-group>
					<sw-input-group label="Description">
						<sw-textarea row="2" />
					</sw-input-group>
				</div>
			...
			<!-- <sw-card class="my-4">
				...
				<div class="grid grid-cols-1 gap-4 md:grid-cols-5">
					...
					<div class="grid grid-cols-1 col-span-4 gap-4 md:grid-cols-3">
						<sw-input-group label="First Name">
							<sw-input />
						</sw-input-group>
						<sw-input-group label="Last Name">
						...
						<sw-input-group label="Phone Number">
							<sw-input>
						...
						<sw-input-group label="Register No.">
							<sw-input prefix="REG" />
						</sw-input-group>
					</div>
				</div>
				...
				<div class="grid grid-cols-1 gap-4 md:grid-cols-5">
					...
					<div class="grid grid-cols-1 col-span-4 gap-4 md:grid-cols-3">
						<sw-input-group label="School Name">
							<sw-input />
						</sw-input-group>
						<sw-input-group label="Collage Name">
							<sw-input />
						</sw-input-group>
						<sw-input-group label="University Name">
							<sw-input />
						</sw-input-group>
						<sw-input-group label="Skill 1">
							<sw-input />
						</sw-input-group>
						<sw-input-group label="Skill 2">
							<sw-input />
						</sw-input-group>
						<sw-input-group label="Skill 3">
							<sw-input />
						</sw-input-group>
					</div>
				</div>
				...
				<div class="grid grid-cols-1 gap-4 md:grid-cols-5">
					<div class="col-span-1">
						<span class="font-semibold">Address Details</span>
					</div>
					<div class="grid grid-cols-1 col-span-4 gap-4 md:grid-cols-3">
						<sw-input-group label="Country">
							<sw-select
						...
						<sw-input-group label="State">
							<sw-input />
						</sw-input-group>
						<sw-input-group label="City">
							<sw-input />
						</sw-input-group>
						<sw-input-group label="Address 1">
							<sw-input />
						</sw-input-group>
						<sw-input-group label="Address 2">
							<sw-input />
						</sw-input-group>
						<sw-input-group label="ZIP code">
							<sw-input />
						</sw-input-group>
					</div>
				</div>
			...
			<!-- <sw-card class="my-4">
				...
				<div class="grid grid-cols-1 gap-4 md:grid-cols-5">
					...
					<div class="col-span-4">
						...
						<sw-input-group variant="horizontal" label="Collage Name" class="mt-2">
							<sw-input />
						</sw-input-group>
						<sw-input-group variant="horizontal" label="University Name" class="mt-2">
							<sw-input />
						</sw-input-group>
						<sw-input-group variant="horizontal" label="Skill 1" class="mt-2">
							<sw-input />
						</sw-input-group>
						<sw-input-group variant="horizontal" label="Skill 2" class="mt-2">
							<sw-input />
						</sw-input-group>
						<sw-input-group variant="horizontal" label="Skill 3" class="mt-2">
							<sw-input />
						</sw-input-group>
					</div>
				</div>
...
export default {
	data() {
		return {
			country1: '',
			hobby: '',
			options1: ['India', 'USA', 'UK', 'Japan'],
			options2: ['Cricket', 'Football', 'Wallyball', 'Ludo'],
			money_1: 0,
			money_2: 0,
			date_1: null,
